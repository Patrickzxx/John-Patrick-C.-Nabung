...
public class milkteaTea {
    ...
    private ButtonGroup wheretoEat;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                milkteaTea window = new milkteaTea();
    ...
    private void initialize() {
        ...
        // Group radio buttons
        wheretoEat = new ButtonGroup();
        wheretoEat.add(rdbtnDineIn);
        wheretoEat.add(rdbtnTakeOut);
